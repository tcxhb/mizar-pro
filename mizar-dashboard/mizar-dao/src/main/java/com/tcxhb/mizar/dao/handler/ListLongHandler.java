...
public class ListLongHandler extends BaseTypeHandler<List<Long>> {
    ...
    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, List<Long> stringListMap, JdbcType jdbcType) throws SQLException {
        String str = toJson(stringListMap);
        ps.setString(i, str);
    }

    @Override
    public List<Long> getNullableResult(ResultSet rs, String s) throws SQLException {
    ...
    public static List<Long> toBeans(String str) {
    ...
    public static String toJson(List<Long> stringListMap) {
